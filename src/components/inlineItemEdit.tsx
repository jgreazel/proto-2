...
export const InlineItemEdit = ({
  ...
  const { mutate: deleteConcession, isLoading: isDeletingConcession } =
  ...
  const { mutate: deleteAdmission, isLoading: isDeletingAdmission } =
  ...
  if (item.item.isConcessionItem) {
    return (
      <ConcessionItemEdit
        ...
        onCancel={onCancel}
        onDelete={() => deleteConcession({ id: item.item.id })}
        isLoading={isLoading}
    ...
    return (
      <AdmissionItemEdit
        ...
        onCancel={onCancel}
        onDelete={() => deleteAdmission({ id: item.item.id })}
        isLoading={isLoading}
        showDeleteConfirm={showDeleteConfirm}
        setShowDeleteConfirm={setShowDeleteConfirm}
      />
