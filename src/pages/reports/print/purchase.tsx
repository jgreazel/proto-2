...
import { PurchaseReportTable } from "..";
...
// ! the first time i have to change all three im making a component
const PurchaseReportPrintPage = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `Purchase Report ${start.toDateString()} - ${end.toDateString()}`,
  ...
  const content =
    isLoading || !data ? (
      ...
      <div>
        ...
        <PurchaseReportTable data={data.purchaseReport} ref={ref} />
      </div>
    );
